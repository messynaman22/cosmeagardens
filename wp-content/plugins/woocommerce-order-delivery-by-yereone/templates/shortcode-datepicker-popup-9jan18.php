<?php global $post; ?>
<h4 style=" font-size: 20px; margin-bottom: auto; margin-top:25px" class="meta-title"><span class="steps">1</span><span><?php _e('Your Recipient', ETHEME_DOMAIN); ?></span></h4>
...
jQuery(document).ready(function() {
    ...
    jQuery(".mydatepckmd").glDatePicker({
    	showAlways: true,
    	hideOnClick: true,
		selectableDateRange: [
