<?php global $post; ?>
<h4 style=" font-size: 20px; margin-bottom: auto; margin-top:25px" class="meta-title"><span class="steps">2</span><span><?php _e('Your Recipient', ETHEME_DOMAIN); ?></span></h4>
<div class="picker-wrapper">
<p>State:<select style="width:100%">
<option>Select State</option>
</select></p>
<p>Delivery Date:<input name="order-selected-date" id="mydate" class="datepicker_modal_open" placeholder="DD/MM/YYYY" gldp-id="mydate" data-toggle="modal" data-target="#datepickerModal" /></p>
</div>
<!-- Modal -->
...
jQuery(document).ready(function() {
	...
	jQuery("body").click(function(){
		...
		jQuery("body #calendar").children(".sun").children("span").html("Premium");
		jQuery("body #calendar").children(".sat").children("span").html("Premium");
	});
